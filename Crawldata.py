...
url = "https://www.nhatot.com/thue-bat-dong-san-tp-ho-chi-minh"
...
page_count = 1
max_pages = 30  # Số trang tối đa bạn muốn thu thập dữ liệu
...
df.to_csv('bat_dong_san1.csv', index=False, encoding='utf-8-sig')
# Hoặc lưu vào file Excel
df.to_excel('bat_dong_san1.xlsx', index=False, engine='openpyxl')
