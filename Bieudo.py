...
def bieudo2(db):
    st.write("## Biểu đồ 2 Tròn: Tỷ lệ tài sản cho thuê và bán")
...
def bieudo3(db):
    st.write("## Biểu đồ 3: Sản lượng giao dịch theo thời gian")
    ...
    choice = st.selectbox("Chọn lọc theo", ["Khu vực", "Thời gian"])
...
def bieudo4(db):
    st.write("## Biểu đồ 4: Bất động sản chưa bán và chưa thuê")
...
def bieudo5(db):
    st.write("## Biểu đồ 5: Giá thuê trung bình")
